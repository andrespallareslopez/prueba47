...
;(function(ns,components,$){
    ...
    ns.UXLoadLink.prototype = new components.container();
    
    ns.UXLoadLink.prototype.initControl=function(options){
        ;(function(options){
    ...
    ns.UXLoadLink.prototype.destroy=function(){

    }
    ns.UXLoadLink.prototype.initEventLoadPanel = function(options){
       var self=this
